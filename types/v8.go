...
func (m *MetadataV8Decoder) Init(data ScaleBytes, subType string, arg ...interface{}) {
...
func (m *MetadataModuleError) Init(data ScaleBytes, subType string, arg ...interface{}) {
	m.Name = ""
	m.Doc = []string{}
	m.ScaleDecoder.Init(data, subType, arg...)
}
